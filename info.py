...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '735078191' '731737877' '7293137491' '1369482318').split()] # For Multiple Id Use One Space Between Each.
