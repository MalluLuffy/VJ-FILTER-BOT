...
API_ID = int(environ.get('API_ID', '24607450'))
API_HASH = environ.get('API_HASH', '204768fe292a431ee267aebaa1dbbd11')
BOT_TOKEN = environ.get('BOT_TOKEN', "8107934937:AAGDXZ3wFOiLGD85EwVH-SaV-tzuE_a6ALU")
APP_URI = environ.get('APP_URI', "https://illegal-josefina-123myemailaddressis-1ff633a4.koyeb.app")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.pinimg.com/736x/a4/33/03/a43303a97ba348179b4ac7997ef5ba2e.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '735078191 7716671566').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002699467290'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002601545632').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002180677578 -1002247439384') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002674153425')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002501054017')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002280816406').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ramanannair1998:TOCEcg4ZKa7ox3Zs@cluster0.5uu5pk4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://illegal-josefina-123myemailaddressis-1ff633a4.koyeb.app/")
