...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002601545632 -1002248826741').split()]  # For Multiple Id Use One Space Between Each.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SAGA_UPDATES')
...
MSG_ALRT = environ.get('MSG_ALRT', ' ꜱᴜᴘᴇʀ‼️ ')
